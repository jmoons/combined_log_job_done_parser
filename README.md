...
1.  Unique Job Listing - In cell `F2` paste the following formula:
    1.  `=UNIQUE(B2:B)`
1.  Minimum Job Duration - In cell `G2` paste the following, deleting/adding as necessary:
...
1.  Maximum Job Duration - In cell `H2` paste the following, deleting/adding as necessary:
...
1.  Average Job Duration - In cell `I2` paste the following, deleting/adding as necessary:
...
1.  Job Count - In cell `J2` paste the following, deleting/adding as necessary:
    1.  `=COUNTIFS(B2:B, F2)`
    1.  `=COUNTIFS(B2:B, F3)`
    1.  `=COUNTIFS(B2:B, F4)`
    1.  `=COUNTIFS(B2:B, F5)`
